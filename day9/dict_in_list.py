...
contains 2 Dictionaries. Your job is to create a function that can add new countries to this list.
...
visits = int(input("How many times you have visited there? ")) # Number of visits
list_of_cities = eval(input("Enter names of the cities: ")) # create list from formatted string
...
def add_new_country(country,visits,list_of_cities):
    ...
    new_item["cities"]=list_of_cities
